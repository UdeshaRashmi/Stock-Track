  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#ECFEFF] via-white to-[#ECFEFF]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-20 w-80 h-80 bg-gradient-to-r from-[#2DD4BF]/10 to-[#22D3EE]/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-20 w-96 h-96 bg-gradient-to-r from-[#22D3EE]/10 to-[#2DD4BF]/10 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="lg:w-1/2 flex flex-col justify-center py-12 lg:py-0">
            ...
            <div className="max-w-lg">
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#2DD4BF]/10 to-[#22D3EE]/10 border border-[#2DD4BF]/20 mb-6">
                ...
                <span className="text-sm font-medium text-[#0F172A]">Start Your Journey</span>
              </div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">
                ...
                <br />
                <span className="text-[#334155]">Join 8,500+ Businesses</span>
              </h1>
              
              <p className="text-lg text-[#334155] mb-10 leading-relaxed">
                Get started with Stock Track and revolutionize how you manage inventory. 
                Free 14-day trial, no credit card required.
              </p>

              {/* Benefits Grid */}
              <div className="grid grid-cols-2 gap-4 mb-12">
                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-[#ECFEFF]">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#2DD4BF]/10 to-[#22D3EE]/10 flex items-center justify-center mb-3">
                    <TrendingUp className="w-5 h-5 text-[#2DD4BF]" />
                  </div>
                  <p className="text-sm font-medium text-[#0F172A]">40% Efficiency Gain</p>
                  <p className="text-xs text-[#334155]">Average user improvement</p>
                </div>
                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-[#ECFEFF]">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#2DD4BF]/10 to-[#22D3EE]/10 flex items-center justify-center mb-3">
                    <Users className="w-5 h-5 text-[#2DD4BF]" />
                  </div>
                  <p className="text-sm font-medium text-[#0F172A]">Team Collaboration</p>
                  <p className="text-xs text-[#334155]">Unlimited team members</p>
                </div>
              </div>

              {/* Testimonial */}
              <div className="bg-gradient-to-r from-[#ECFEFF] to-white/50 rounded-xl p-6 border border-[#2DD4BF]/20">
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#2DD4BF] to-[#22D3EE] flex items-center justify-center text-white font-bold">
                    SC
                  </div>
                  <div>
                    <p className="text-sm text-[#0F172A] font-medium">"Stock Track transformed our inventory management. We saved 15 hours per week!"</p>
                    <p className="text-xs text-[#334155] mt-1">Sarah Chen, TechGear Inc.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-md">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-[#ECFEFF]/50 shadow-2xl p-8 lg:p-10">
                <div className="text-center mb-8">
                  ...
                  <p className="text-[#334155] mt-2">Start your free 14-day trial</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-xs text-[#334155]">
                        ...
                        <span className={`ml-1 font-medium ${
                          passwordStrength >= 4 ? 'text-[#2DD4BF]' : 
                          passwordStrength >= 2 ? 'text-amber-500' : 
                          passwordStrength > 0 ? 'text-[#FB7185]' : 
                          'text-[#334155]'
                        }`}>
                    ...
                    <div className="space-y-2 pt-2">
                      {passwordRequirements.map((req, index) => (
                        <div key={index} className="flex items-center space-x-2">
                          <CheckCircle className={`w-4 h-4 ${req.met ? 'text-[#2DD4BF]' : 'text-[#ECFEFF]'}`} />
                          <span className={`text-xs ${req.met ? 'text-[#334155]' : 'text-[#334155]/60'}`}>
                            {req.text}
                          </span>
                        </div>
                      ))}
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="flex items-center h-5">
                      <input
                        ...
                        type="checkbox"
                        required
                        className="w-4 h-4 rounded border-[#ECFEFF] text-[#2DD4BF] focus:ring-[#2DD4BF]/20"
                      />
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-white/80 text-[#334155]">Or sign up with</span>
                    </div>
                  </div>
              ...
              <div className="mt-8 text-center">
                <div className="flex items-center justify-center space-x-6 text-sm text-[#334155]">
      ...
      {/* Floating Elements */}
      <div className="fixed top-32 left-20 w-2 h-2 bg-[#2DD4BF] rounded-full animate-ping opacity-20"></div>
      <div className="fixed bottom-40 right-16 w-1 h-1 bg-[#22D3EE] rounded-full animate-pulse"></div>
      <div className="fixed top-1/3 left-32 w-3 h-3 bg-[#FB7185] rounded-full animate-ping opacity-30"></div>
    </div>
  );
};
